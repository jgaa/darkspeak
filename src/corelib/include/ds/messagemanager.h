...
public:
    ...
    Message::ptr_t getMessage(const QByteArray& messageId, const int conversationId);
    Message::ptr_t getMessage(const QByteArray& messageId, const Message::Direction direction);
